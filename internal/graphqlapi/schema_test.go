...
func forYouTerms() []weightedRankTerm {
	...
	return []weightedRankTerm{
		...
		{Kind: weightedRankTermReferences, References: gated, Metric: genericMetric{Name: "k7_e.actors"}, Weight: 3, Transform: "LOG1P"},
		{Kind: weightedRankTermReferences, References: gated, Metric: genericMetric{Name: "k1_1111_e_reply.sources"}, Weight: 2.5, Transform: "LOG1P"},
		{Kind: weightedRankTermReferences, References: gated, Metric: genericMetric{Name: "k6_16_e.actors"}, Weight: 2, Transform: "LOG1P"},
		{Kind: weightedRankTermReferences, References: gated, Metric: genericMetric{Name: "k9735_e.value_total"}, Weight: 1.5, Transform: "LOG1P"},
...
func TestFeatureWeightsFromTerms_BailsOnUnrecognized(t *testing.T) {
	...
	cases := map[string][]weightedRankTerm{
		...
		"non-log1p engagement": {{Kind: weightedRankTermReferences, References: gated, Metric: genericMetric{Name: "k7_e.actors"}, Transform: "IDENTITY"}},
		// Ungated engagement (counts ALL engagers, e.g. trending) has no real_* column.
		"ungated engagement":  {{Kind: weightedRankTermReferences, Metric: genericMetric{Name: "k7_e.actors"}, Transform: "LOG1P"}},
